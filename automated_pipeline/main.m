...
%--save files
unproc_save_file   = [save_prefix '_unproc_data.mat'];
proc_save_file     = [save_prefix '_proc_data.mat'];
call_seg_save_file = [save_prefix '_call_seg_data.mat'];
call_breath_seg_save_file = [save_prefix '_call_breath_seg_data.mat'];
vicinity_save_file = [save_prefix '_vicinity.mat']
