...
% 2024.02.14 CDR
% 
% Batch run processing pipeline

clear;

cd /Users/cirorandazzo/code/stim-call-analysis

param_file_folder = './parameters';  % analyze from all parameter files in this folder
...
for pfile_i = length(parameter_files):-1:1
    ...
    summary_bird(pfile_i).file = [parameter_files(pfile_i).folder '/' parameter_files(pfile_i).name];
    ...
    clearvars -except a current_dir group_figure_save_folder group_figure_save_format i parameter_files run_dt summary_bird verbose;
